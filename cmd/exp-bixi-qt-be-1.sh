...
${myDir}/query-from-hbase.sh ../schema/bixi.qt.be.1.schema ../csv/bixi.conf ../conf/ 0 1 $ii
done

for dd in $long; do
echo "**********Coprocessor for *$dd*****************"
${myDir}/query-from-hbase.sh ../schema/bixi.qt.be.1.schema ../csv/bixi.conf ../conf/ 0 1 $dd
done
